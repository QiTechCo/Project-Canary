#!/usr/bin/env python3
"""
scripts/ingest-legistar-rss.py
Charlotte City Council Legistar RSS Feed Ingestion & Real-Time Listener.
Scrapes Granicus Legistar RSS feeds for real-time agenda packets, newly posted items,
matter files, and meeting detail feeds as they are published by the City Clerk.
"""
